        ...
        <>{depLoading ? <div>Loading...</div> :
            <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="dept_name" className='text-l font-medium text-gray-700 mb-6'>Department Name </label>
                        <input type="text" name='dept_name' onChange={handleChange} value={department.dept_name} placeholder='Department Name' className='mt-1 w-full p-2 border mb-3 border-gray-300 rounded-md' />
                    </div>
                    <div>
                    ...
                    <button type='submit' className='w-full mt-6 text-xl bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded'>Edit Department</button>
                </form>
            </div>
        }</>
    )
