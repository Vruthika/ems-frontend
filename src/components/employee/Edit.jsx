                ...
                <form onSubmit={handleSubmit}>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <select name="department" onChange={handleChange} value={employee.department} className='mt-1 p-2 block w-full border border-gray-300 rouded-md' required>
                    ...
                    <button type='submit' className='w-full text-xl mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-md'>
                        Edit Details
                    </button>
                </form>
            </div>
