        ...
        <>{leave ? (
            <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div>
                        <img src={`http://localhost:5000/${leave.employeeId.userId.profileImage}`} className='rounded-full border w-72 h-72 object-cover' />
                    </div>
                    <div>
                        ...
                        <div className='flex space-x-3 mb-5'>
                            ...
                            <p className='text-lg font-medium'>{leave.employeeId.department.dept_name}</p>
                        </div>
                        <div className='flex space-x-3 mb-5'>
                        ...
                        <div className='flex space-x-3 mb-5'>
                            <p className='text-xl font-bold'>{leave.status === "Pending" ? "Action" : "Status:"}</p>
